...
// // Import course images (you'll need to add these to your project)
...
// import SelfPacedImage from "/images/munich.jpg";
...
//                   <Button 
//                     className="w-full bg-german hover:bg-german-dark shadow-sm transition-all duration-300 hover:shadow-md"
//                     asChild
//                   >
//                     <Link to={course.path}>
